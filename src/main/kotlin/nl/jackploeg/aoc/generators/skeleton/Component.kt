...
object Component {
  fun setupTestComponent(year: String, day: String) {
    val path = Paths.get("$TEST_DIRECTORY/kotlin/nl/jackploeg/aoc/_$year/TestDayComponent.kt")
  ...
  private fun alterTestDayComponent(year: String, day: String) {
    ...
    val content = String(Files.readAllBytes(path))
      ...
      .replace("import javax.inject.Singleton".toRegex(), "import nl.jackploeg.aoc._$year.calendar.day$day.Day${day}Test\nimport javax.inject.Singleton")
    Files.write(path, content.toByteArray())
  }

  private fun createTestDayComponent(year: String, day: String) {
    val file = FileSpec.builder("nl.jackploeg.aoc._$year", "TestDayComponent")
      .addType(
        TypeSpec.interfaceBuilder("TestDayComponent")
          ...
          .addFunction(
            FunSpec.builder("inject")
              ...
              .addParameter("day${day}Test", ClassName("nl.jackploeg.aoc._$year.calendar.day$day", "Day${day}Test"))
              .build()
          )
          .build()
      )
