...
import nl.jackploeg.aoc.generators.skeleton.SkeletonGenerator.Companion.TEST_DIRECTORY
import java.io.File
...
object TestClass {
  fun generateTestClass(year: String, day: String) {
    val file = FileSpec.builder("nl.jackploeg.aoc._$year.calendar.day$day", "Day${day}Test")
      .addImport(ClassName("nl.jackploeg.aoc", "_$year"), "DaggerTestDayComponent")
        ...
        TypeSpec.classBuilder("Day${day}Test")
          ...
          .addType(
            TypeSpec.companionObjectBuilder()
              ...
              .addProperty(
                PropertySpec.builder("DAY_${day}_TEST", String::class)
                  .initializer("%S", "$INPUT_DIRECTORY/$year/day$day.test")
                  .addModifiers(PRIVATE, CONST)
                  .build()
              )
              .build()
          ...
          .addProperty(
            PropertySpec.builder("day$day", ClassName("nl.jackploeg.aoc._$year.calendar.day$day", "Day$day"))
              .addAnnotation(Inject::class)
              .addModifiers(LATEINIT)
              .mutable(true)
              .build()
          ).addFunction(
            FunSpec.builder("testDay${day}PartOneTestInput")
              .addAnnotation(ClassName("org.junit.jupiter.api", "Test"))
              .addStatement("assertEquals(-1, day${day}.partOne(DAY_${day}_TEST))")
              .build()
          ).addFunction(
            FunSpec.builder("testDay${day}PartTwoTestInput")
              .addAnnotation(ClassName("org.junit.jupiter.api", "Test"))
              .addStatement("assertEquals(-1, day${day}.partTwo(DAY_${day}_TEST))")
              .build()
          ).addFunction(
    ...
    val path = Paths.get("$TEST_DIRECTORY/kotlin/nl/jackploeg/aoc/_$year/calendar/day$day/Day${day}Test.kt")
