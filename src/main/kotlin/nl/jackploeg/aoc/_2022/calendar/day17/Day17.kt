...
class Day17 @Inject constructor(
    ...
    fun partOne(filename: String) = dropRocks(filename)

    fun partTwo(filename: String) = dropRocks(filename, false)

    fun dropRocks(fileName: String, stopAt2022: Boolean = true): Long {
        ...
        while (rocksDropped < totalRocksToDrop) {
            ...
            rocksDropped++
            if (stopAt2022 && rocksDropped == 2022L)
                return top.toLong()
        }
        return top + added
    }
