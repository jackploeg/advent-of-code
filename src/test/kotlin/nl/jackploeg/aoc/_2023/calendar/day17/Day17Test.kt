...
internal class Day17Test {
  ...
  fun testDay17PartOneTestInput() {
    assertEquals(102, day17.partOne(DAY_17_TEST))
  }

  @Test
  fun testDay17PartTwoTestInput() {
    assertEquals(94, day17.partTwo(DAY_17_TEST))
  }

  @Test
  fun testDay17PartOne() {
    assertEquals(956, day17.partOne(DAY_17))
  }

  @Test
  fun testDay17PartTwo() {
    assertEquals(1106, day17.partTwo(DAY_17))
  }

  companion object {
    private const val DAY_17: String = "advent-of-code-input/2023/day17.input"
    private const val DAY_17_TEST: String = "advent-of-code-input/2023/day17.test"
  }
}
