...
internal class Day22Test {
  ...
  fun testDay22PartOneTestInput() {
    assertEquals(5, day22.partOne(DAY_22_TEST))
  }

  @Test
  fun testDay22PartTwoTestInput() {
    assertEquals(7, day22.partTwo(DAY_22_TEST))
  }

  @Test
  fun testDay22PartOne() {
    assertEquals(401, day22.partOne(DAY_22))
  }

  @Test
  fun testDay22PartTwo() {
    assertEquals(63491, day22.partTwo(DAY_22))
  }

  companion object {
    private const val DAY_22: String = "advent-of-code-input/2023/day22.input"
    private const val DAY_22_TEST: String = "advent-of-code-input/2023/day22.test"
  }
}
