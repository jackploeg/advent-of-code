...
internal class Day23Test {
  ...
  fun testDay23PartOneTestInput() {
    assertEquals(94, day23.partOne(DAY_23_TEST))
  }

  @Test
  fun testDay23PartTwoTestInput() {
    assertEquals(154, day23.partTwo(DAY_23_TEST))
  }

  @Test
  fun testDay23PartOne() {
    assertEquals(1998, day23.partOne(DAY_23))
  }

  @Test
  fun testDay23PartTwo() {
    assertEquals(6434, day23.partTwo(DAY_23))
  }

  companion object {
    private const val DAY_23: String = "advent-of-code-input/2023/day23.input"
    private const val DAY_23_TEST: String = "advent-of-code-input/2023/day23.test"
  }
}
