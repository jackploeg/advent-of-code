...
internal class Day08Test {
  ...
  fun testDay08PartOneTestInput() {
    assertEquals(21, day08.partOne(DAY_08_TEST))
  }

  @Test
  fun testDay08PartTwoTestInput() {
    assertEquals(8, day08.partTwo(DAY_08_TEST))
  }

  @Test
  fun testDay08PartOne() {
    assertEquals(1711, day08.partOne(DAY_08))
  }

  @Test
  fun testDay08PartTwo() {
    assertEquals(301392, day08.partTwo(DAY_08))
  }

  companion object {
    private const val DAY_08: String = "advent-of-code-input/2022/day08.input"

    private const val DAY_08_TEST: String = "advent-of-code-input/2022/day08.test"
  }
}
