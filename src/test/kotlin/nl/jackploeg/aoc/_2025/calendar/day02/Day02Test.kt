...
internal class Day02Test {
  ...
  fun testDay02PartOneTestInput() {
    assertEquals(1227775554, day02.partOne(DAY_02_TEST))
  }

  @Test
  fun testDay02PartTwoTestInput() {
    assertEquals(4174379265, day02.partTwo(DAY_02_TEST))
  }

  @Test
  fun testDay02PartOne() {
    assertEquals(24043483400, day02.partOne(DAY_02))
  }

  @Test
  fun testDay02PartTwo() {
    assertEquals(38262920235, day02.partTwo(DAY_02))
  }

  companion object {
    private const val DAY_02: String = "advent-of-code-input/2025/day02.input"

    private const val DAY_02_TEST: String = "advent-of-code-input/2025/day02.test"
  }
}
