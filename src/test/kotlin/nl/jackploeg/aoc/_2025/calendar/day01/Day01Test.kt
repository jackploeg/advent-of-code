...
internal class Day01Test {
  ...
  fun testDay01PartTwoTestInput() {
    assertEquals(6, day01.partTwo(DAY_01_TEST))
  }

  @Test
  fun testDay01PartOne() {
    assertEquals(1040, day01.partOne(DAY_01))
  }

  @Test
  fun testDay01PartTwo() {
    assertEquals(6027, day01.partTwo(DAY_01))
  }

  companion object {
    private const val DAY_01: String = "advent-of-code-input/2025/day01.input"

    private const val DAY_01_TEST: String = "advent-of-code-input/2025/day01.test"
  }
}
