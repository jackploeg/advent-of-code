...
internal class Day07Test {
  ...
  fun testDay07PartOneTestInput() {
    assertEquals(21, day07.partOne(DAY_07_TEST))
  }

  @Test
  fun testDay07PartTwoTestInput() {
    assertEquals(40, day07.partTwo(DAY_07_TEST))
  }

  @Test
  fun testDay07PartOne() {
    assertEquals(1687, day07.partOne(DAY_07))
  }

  @Test
  fun testDay07PartTwo() {
    assertEquals(390684413472684, day07.partTwo(DAY_07))
  }

  companion object {
    private const val DAY_07: String = "advent-of-code-input/2025/day07.input"

    private const val DAY_07_TEST: String = "advent-of-code-input/2025/day07.test"
  }
}
