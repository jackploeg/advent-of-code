...
internal class Day03Test {
  ...
  fun testDay03PartOneTestInput() {
    assertEquals(357, day03.partOne(DAY_03_TEST))
  }

  @Test
  fun testDay03PartTwoTestInput() {
    assertEquals(3121910778619, day03.partTwo(DAY_03_TEST))
  }

  @Test
  fun testDay03PartOne() {
    assertEquals(17524, day03.partOne(DAY_03))
  }

  @Test
  fun testDay03PartTwo() {
    assertEquals(173848577117276, day03.partTwo(DAY_03))
  }

  companion object {
    private const val DAY_03: String = "advent-of-code-input/2025/day03.input"

    private const val DAY_03_TEST: String = "advent-of-code-input/2025/day03.test"
  }
}
